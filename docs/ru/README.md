...
Монорепозиторий с инструментами для анализа истории git и построения release core в соответствии со [спецификацией Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/).
...
- [`@modulify/conventional-release`](../../packages/conventional-release) — Library-first release-core пакет с конфигурируемым CLI.
...
Он не публикует пакеты в npm и не создаёт hosted releases в GitHub или GitLab.
Такие delivery-шаги предполагаются уже в более верхнеуровневых инструментах поверх этого core.
...
Проект возник не как абстрактный эксперимент, а из практической потребности работать с глубоко
вложенными деревьями workspaces, включая репозитории с двумя или тремя уровнями вложенности,
тогда как большинство release-инструментов на рынке до сих пор предполагают плоскую или почти плоскую монорепу.
